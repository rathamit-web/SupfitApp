...
type InternalLegendProps = { payload?: LegendItem[]; verticalAlign?: 'top' | 'bottom' };

const ChartLegendContent = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<'div'> & InternalLegendProps & { hideIcon?: boolean; nameKey?: string }
